...
berteduh (shelter) - dalam 800m dari tiap stasiun MRT, biar backend gak perlu manggil
...
poi_green_mrt_work.json - kalau ke-stop/gagal di tengah jalan, jalankan lagi
`python poi_green_mrt.py`, otomatis lanjut dari stasiun yang belum selesai.
"""
...
async def target_stations() -> list[dict]:
    """MRT stations (OSM) - TJ (this project's other poi_green_tj.py) is the only mode
