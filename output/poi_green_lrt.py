...
berteduh (shelter) - dalam 800m dari tiap stasiun LRT, biar backend gak perlu manggil
...
poi_green_lrt_work.json - kalau ke-stop/gagal di tengah jalan, jalankan lagi
`python poi_green_lrt.py`, otomatis lanjut dari stasiun yang belum selesai.
"""
...
async def target_stations() -> list[dict]:
    """LRT stations (OSM) - TJ (this project's poi_green_tj.py) is the only mode sourced
