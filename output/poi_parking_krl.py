...
tetap OSM, didownload sekali jadi static dalam 800m dari tiap stasiun KRL, biar backend
...
poi_parking_krl_work.json - kalau ke-stop/gagal di tengah jalan, jalankan lagi
`python poi_parking_krl.py`, otomatis lanjut dari stasiun yang belum selesai.
"""
