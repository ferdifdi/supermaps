...
static dalam 800m dari tiap stasiun MRT (bukan 800m kayak MRT/KRL/LRT - lihat
...
poi_residential_mrt_work.json - kalau ke-stop di tengah jalan (proses dimatikan paksa dkk),
jalankan lagi `python poi_residential_mrt.py`, otomatis lanjut dari stasiun yang belum
...
permanen mulai run berikutnya - lihat poi_residential_mrt_giveup.json - biar stasiun yang
...
GIVEUP_FILE = OUT_DIR / "poi_residential_mrt_giveup.json"
