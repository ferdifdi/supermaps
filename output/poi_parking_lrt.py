...
tetap OSM, didownload sekali jadi static dalam 800m dari tiap stasiun LRT, biar backend
...
poi_parking_lrt_work.json - kalau ke-stop/gagal di tengah jalan, jalankan lagi
`python poi_parking_lrt.py`, otomatis lanjut dari stasiun yang belum selesai.
"""
