...
static dalam 800m dari tiap stasiun KRL, biar backend gak perlu manggil osm.pois() live
...
poi_residential_krl_work.json - kalau ke-stop/gagal di tengah jalan, jalankan lagi
`python poi_residential_krl.py`, otomatis lanjut dari stasiun yang belum selesai.
"""
