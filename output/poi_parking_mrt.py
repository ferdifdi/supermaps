...
tetap OSM, didownload sekali jadi static dalam 800m dari tiap stasiun MRT, biar backend
...
poi_parking_mrt_work.json - kalau ke-stop/gagal di tengah jalan, jalankan lagi
`python poi_parking_mrt.py`, otomatis lanjut dari stasiun yang belum selesai.
"""
